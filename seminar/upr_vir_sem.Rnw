...
\section[HIV]{Transient virulence of HIV}
...
\begin{frame}
\frametitle{Epidemiological models for HIV \cite{champredon_hiv_2013}}

% -- convert journal.pone.0082906.g001.png -crop 100%x50% output.png--

\includegraphics[width=\textwidth]{champ1.png}
\end{frame}
...
\includegraphics{pix/LHScrop.png}
...
\begin{frame}
\frametitle{Virulence trajectories}
